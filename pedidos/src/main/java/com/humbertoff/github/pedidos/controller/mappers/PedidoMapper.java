...
import com.humbertoff.github.pedidos.model.enums.StatusPedido;
...
public interface PedidoMapper {
    ...
    private static BigDecimal calcularTotal(Pedido pedido) {
        return pedido.getItens().stream().map(
                itemPedido -> itemPedido.getValorUnitario().multiply(BigDecimal.valueOf(itemPedido.getQuantidade()))
